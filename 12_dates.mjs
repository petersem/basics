...
// 
logger('Get current date and display in different formats')
...
//
logger('international date time formatter');
...
//
logger('Adding or subtracting with dates');
